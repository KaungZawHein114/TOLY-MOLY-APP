# TOLY MOLY — AI Task Scoper (Firebase + OpenAI) [ARCHIVED]

> **Archived 2026-07-29** as part of the Firebase removal / "AI features become demo logic"
> refactor. This is a preserved copy of `functions/README.md` from the deleted Firebase Cloud
> Functions backend — kept for reference only. Nothing here is live; see
> `docs/superpowers/specs/2026-07-29-ai-task-assistant-design.md` for what replaces it, and
> `docs/ai/cloud-function-prompts.md` for every system prompt these functions used, compiled in
> one place.
