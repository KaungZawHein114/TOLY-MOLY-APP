...
// ----------------------------------------------------------------------------
// WORKERS (54) — const list, loaded at compile time. ids 1-16 are the
// original set (do not renumber — loggedInWorker below is index-based);
// ids 17-54 round every category out to 5-7 taskers so per-category features
// (the AI Tasker Finder, category browse) have a realistic pool instead of
// 1-2 taskers each.
// ----------------------------------------------------------------------------
const List<Worker> workers = [
  ...
  Worker(
    ...
    distanceMiles: 1.7,
    isAvailableNow: true,
    bio: "ရေပူစက်နှင့် ရေပိုက်များ ပြင်ဆင်ရေး ကျွမ်းကျင်သူ။ အိမ်သုံးပစ္စည်းများအတွက် လျင်မြန်တိကျသော ဝန်ဆောင်မှု။",
    currentTier: 4,
    township: "လှိုင်",
    completedTasks: 98,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 3.0,
    isAvailableNow: true,
    bio: "စီးပွားရေးအဆောက်အအုံကြီးများအတွက် ရေပိုက်လိုင်း အကြီးစား ပြုပြင်ရေး အတွေ့အကြုံ ၁၅ နှစ်ကျော်။ လိုင်စင်ရအဖွဲ့နှင့် လုပ်ဆောင်ပါသည်။",
    currentTier: 7,
    township: "ကမာရွတ်",
    completedTasks: 320,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 2.3,
    isAvailableNow: false,
    bio: "စတင်လုပ်ကိုင်နေသူ ငယ်ရွယ်သော ပလန်ဘာ။ ဈေးနှုန်း သက်သာစွာဖြင့် အခြေခံပြင်ဆင်မှုများ လုပ်ဆောင်ပေးပါသည်။",
    currentTier: 1,
    township: "မရမ်းကုန်း",
    completedTasks: 18,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 4.6,
    isAvailableNow: true,
    bio: "ရေချိုးခန်း တပ်ဆင်ခြင်းနှင့် ရေပုံလဲလှယ်ခြင်း ကျွမ်းကျင်သည့် အမျိုးသမီး ပလန်ဘာ။",
    currentTier: 3,
    township: "အင်းစိန်",
    completedTasks: 60,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 5.8,
    isAvailableNow: false,
    bio: "ရေတိုင်ကီနှင့် ရေမြောင်း သန့်ရှင်းရေး ဝန်ဆောင်မှု အထူးပြု။ အချိန်ပေးနိုင်သည့်အခါ မကြာခဏ ရနိုင်ပါသည်။",
    currentTier: 2,
    township: "လှိုင်",
    completedTasks: 44,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 2.8,
    isAvailableNow: true,
    bio: "အိမ်တွင်း ဝိုင်ယာကြိုးအသစ်လဲခြင်းနှင့် မီးလင်းစနစ် တပ်ဆင်ခြင်း ဝန်ဆောင်မှု။",
    currentTier: 4,
    township: "ကမာရွတ်",
    completedTasks: 76,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 1.5,
    isAvailableNow: true,
    bio: "စက်ရုံနှင့် ကုန်လှောင်ရုံများအတွက် လျှပ်စစ်စနစ် အကြီးစား လုပ်ဆောင်သည့် အတွေ့အကြုံ ၁၈ နှစ်။",
    currentTier: 7,
    township: "မရမ်းကုန်း",
    completedTasks: 340,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 4.4,
    isAvailableNow: false,
    bio: "ခလုတ်နှင့် ပလပ်ပေါက် ငယ်ငယ်ပြင်ဆင်မှုများအတွက် ဈေးနှုန်းသက်သာစွာ ဝန်ဆောင်ပေးပါသည်။",
    currentTier: 2,
    township: "အင်းစိန်",
    completedTasks: 25,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 3.3,
    isAvailableNow: true,
    bio: "နေရောင်ခြည်စွမ်းအင် (solar) နှင့် စမတ်အိမ်စနစ် တပ်ဆင်ခြင်း ကျွမ်းကျင်သည့် အမျိုးသမီး အင်ဂျင်နီယာ။",
    currentTier: 4,
    township: "လှိုင်",
    completedTasks: 65,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 1.3,
    isAvailableNow: true,
    bio: "အိမ်နှင့် ရုံးခန်း အပြည့်အစုံ သန့်ရှင်းရေး ဝန်ဆောင်မှု၊ လိုအပ်ပါက ပြတင်းပေါက်နှင့် ကာဗက်လျှော်ခြင်းလည်း လုပ်ဆောင်ပေးပါသည်။",
    currentTier: 5,
    township: "ကမာရွတ်",
    completedTasks: 190,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 3.6,
    isAvailableNow: true,
    bio: "ရုံးခန်းများနှင့် ကုန်တိုက်များအတွက် ညနေပိုင်း သန့်ရှင်းရေး ဝန်ဆောင်မှု။",
    currentTier: 2,
    township: "မရမ်းကုန်း",
    completedTasks: 30,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 0.7,
    isAvailableNow: false,
    bio: "အဆောက်အအုံအသစ် ဆောက်လုပ်ပြီးနောက် သန့်ရှင်းရေးနှင့် အိမ်ပြောင်းရွှေ့ခြင်း သန့်ရှင်းရေး အထူးကျွမ်းကျင်သူ။",
    currentTier: 6,
    township: "အင်းစိန်",
    completedTasks: 240,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 2.9,
    isAvailableNow: true,
    bio: "အဝတ်လျှော်ခြင်းနှင့် မီးပူတိုက်ခြင်း ဝန်ဆောင်မှုပါ ပါဝင်သော သန့်ရှင်းရေးအဖွဲ့။",
    currentTier: 3,
    township: "လှိုင်",
    completedTasks: 55,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 5.2,
    isAvailableNow: false,
    bio: "အသစ်စတင်နေသူ၊ ဈေးနှုန်းသက်သာစွာဖြင့် အခန်းငယ်များ သန့်ရှင်းရေး ဝန်ဆောင်မှု။",
    currentTier: 1,
    township: "ကမာရွတ်",
    completedTasks: 12,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 2.2,
    isAvailableNow: true,
    bio: "စိတ်ကြိုက် ပရိဘောဂနှင့် ခန်းဆီးများ ပြုလုပ်ပေးသည့် အတွေ့အကြုံရင့် လက်သမား။",
    currentTier: 5,
    township: "မရမ်းကုန်း",
    completedTasks: 150,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 4.1,
    isAvailableNow: true,
    bio: "ကျွန်းသားပရိဘောဂနှင့် ရိုးရာလက်ရာများအတွက် ၂၀ နှစ်ကျော် အတွေ့အကြုံရှိသူ ကျွမ်းကျင်လက်သမား။",
    currentTier: 7,
    township: "အင်းစိန်",
    completedTasks: 400,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 1.9,
    isAvailableNow: false,
    bio: "တံခါး၊ ပြတင်းပေါက်ငယ် ပြင်ဆင်မှုများအတွက် စတင်လုပ်ကိုင်နေသူ လက်သမား။",
    currentTier: 2,
    township: "လှိုင်",
    completedTasks: 22,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 3.5,
    isAvailableNow: true,
    bio: "မီးဖိုချောင် ကက်ဘင်နက်နှင့် သိုလှောင်ဗီးနံရံ စင်များ တပ်ဆင်ပေးသူ။",
    currentTier: 3,
    township: "ကမာရွတ်",
    completedTasks: 58,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 1.1,
    isAvailableNow: true,
    bio: "အိမ်သုံး Split-type အဲယားကွန်း သန့်ရှင်းခြင်းနှင့် ပြင်ဆင်ခြင်း ဝန်ဆောင်မှု။",
    currentTier: 4,
    township: "မရမ်းကုန်း",
    completedTasks: 130,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 3.7,
    isAvailableNow: true,
    bio: "ကုမ္ပဏီနှင့် စက်ရုံများအတွက် အဲယားကွန်းစနစ်ကြီးများ ထိန်းသိမ်းခြင်း အတွေ့အကြုံရင့်။",
    currentTier: 7,
    township: "အင်းစိန်",
    completedTasks: 380,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 5.4,
    isAvailableNow: false,
    bio: "ဂတ်ဆ်ပြန်ဖြည့်ခြင်းနှင့် အခြေခံစစ်ဆေးမှုများအတွက် ဈေးနှုန်းသက်သာသော ဝန်ဆောင်မှု။",
    currentTier: 2,
    township: "လှိုင်",
    completedTasks: 28,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 2.6,
    isAvailableNow: true,
    bio: "တိုက်ခန်းသုံး အဲယားကွန်း အသစ်တပ်ဆင်ခြင်း ကျွမ်းကျင်သည့် အမျိုးသမီး နည်းပညာရှင်။",
    currentTier: 3,
    township: "ကမာရွတ်",
    completedTasks: 50,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 1.8,
    isAvailableNow: true,
    bio: "အထက်တန်းအတွက် သင်္ချာနှင့် ရူပဗေဒ သင်ကြားပေးသူ၊ စာမေးပွဲအောင်နှုန်း မြင့်မားသည်။",
    currentTier: 5,
    township: "မရမ်းကုန်း",
    completedTasks: 80,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 2.4,
    isAvailableNow: false,
    bio: "တက္ကသိုလ်ဝင်ခွင့် ဓာတုဗေဒနှင့် ဇီဝဗေဒ အထူးပြု ဆရာမ။ အတွေ့အကြုံ ၂၀ နှစ်။",
    currentTier: 7,
    township: "အင်းစိန်",
    completedTasks: 90,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 4.0,
    isAvailableNow: true,
    bio: "တက္ကသိုလ်ကျောင်းသား၊ အင်္ဂလိပ်စကားပြော အလေ့အကျင့် သင်ပေးသူ။",
    currentTier: 1,
    township: "လှိုင်",
    completedTasks: 10,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 3.1,
    isAvailableNow: true,
    bio: "မူလတန်းကလေးများအတွက် ဘာသာရပ်အားလုံး ကူညီသင်ကြားပေးသူ။",
    currentTier: 4,
    township: "ကမာရွတ်",
    completedTasks: 45,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 2.0,
    isAvailableNow: true,
    bio: "အဆေးသုတ်ခြင်းနှင့် အထွေထွေ အိမ်ပြင်ဆင်မှုများ လုပ်ဆောင်ပေးသူ။",
    currentTier: 3,
    township: "မရမ်းကုန်း",
    completedTasks: 70,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 1.4,
    isAvailableNow: true,
    bio: "မည်သည့်အိမ်တွင်း ပြင်ဆင်မှုမဆို လုပ်ဆောင်ပေးနိုင်သည့် အတွေ့အကြုံ ၁၄ နှစ်ရှိ ပညာရှင်။",
    currentTier: 6,
    township: "အင်းစိန်",
    completedTasks: 220,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 4.9,
    isAvailableNow: false,
    bio: "စတင်လုပ်ကိုင်နေသူ၊ သေးငယ်သော အထွေထွေ အလုပ်များ လုပ်ဆောင်ပေးပါသည်။",
    currentTier: 1,
    township: "လှိုင်",
    completedTasks: 8,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 3.3,
    isAvailableNow: true,
    bio: "ပရိဘောဂတပ်ဆင်ခြင်းနှင့် နံရံပေါ် ပစ္စည်းများ ချိတ်ဆွဲပေးခြင်း ဝန်ဆောင်မှု။",
    currentTier: 2,
    township: "ကမာရွတ်",
    completedTasks: 38,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 3.2,
    isAvailableNow: true,
    bio: "ဥယျာဉ်ခြံပြင်ဆင်ခြင်းနှင့် အပင်ညှပ်ခြင်း ဝန်ဆောင်မှု။",
    currentTier: 3,
    township: "မရမ်းကုန်း",
    completedTasks: 50,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 5.6,
    isAvailableNow: true,
    bio: "ပန်းအမျိုးမျိုးနှင့် အသီးပင်များ စိုက်ပျိုးထိန်းသိမ်းရေး ကျွမ်းကျင်သူ၊ အတွေ့အကြုံ ၁၂ နှစ်။",
    currentTier: 6,
    township: "အင်းစိန်",
    completedTasks: 130,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 2.5,
    isAvailableNow: false,
    bio: "မြက်ခင်း ရိတ်ခြင်းနှင့် ရိုးရိုး ဥယျာဉ်ထိန်းသိမ်းမှု ဈေးနှုန်းသက်သာစွာ ဝန်ဆောင်ပေးပါသည်။",
    currentTier: 2,
    township: "လှိုင်",
    completedTasks: 20,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 4.3,
    isAvailableNow: true,
    bio: "လေယာဉ်ပျံထပ် ဥယျာဉ်ငယ်များနှင့် အိုးအပင်များ ထိန်းသိမ်းပေးသူ အမျိုးသမီး ဥယျာဉ်မှူး။",
    currentTier: 3,
    township: "ကမာရွတ်",
    completedTasks: 32,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 1.0,
    isAvailableNow: true,
    bio: "ရန်ကုန်တွင်းတစ်နေ့တည်း မော်တော်ဆိုင်ကယ်ဖြင့် ပို့ဆောင်ပေးသူ။",
    currentTier: 3,
    township: "မရမ်းကုန်း",
    completedTasks: 210,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 2.9,
    isAvailableNow: true,
    bio: "ပရိဘောဂနှင့် ပစ္စည်းအကြီးစားများ ဗင်ယာဉ်ဖြင့် ပို့ဆောင်ပေးသည့် အတွေ့အကြုံရင့်။",
    currentTier: 6,
    township: "အင်းစိန်",
    completedTasks: 500,
    isVerified: true,
  ...
  Worker(
    ...
    distanceMiles: 4.7,
    isAvailableNow: false,
    bio: "စက်ဘီးဖြင့် ပစ္စည်းသေးသေးများ ပို့ဆောင်ပေးသူ၊ ဈေးနှုန်းသက်သာသည်။",
    currentTier: 1,
    township: "လှိုင်",
    completedTasks: 25,
    isVerified: false,
  ...
  Worker(
    ...
    distanceMiles: 3.4,
    isAvailableNow: true,
    bio: "ဈေးဝယ်ပစ္စည်းများနှင့် အစားအစာ ပို့ဆောင်ပေးသူ အမျိုးသမီး စီးနင်းသူ။",
    currentTier: 2,
    township: "ကမာရွတ်",
    completedTasks: 48,
    isVerified: false,
...
final List<Job> jobs = [
  ...
  Job(
    ...
    distanceMiles: 3.2,
    isUrgent: false,
    aiSuggestedBudgetMmk: 32000,
    requiredTier: 3,
    dateTime: DateTime.now().add(const Duration(days: 2)),
    description: "အိပ်ခန်းနှစ်ခန်း နံရံဆေးသုတ်ရန်၊ သန့်ရှင်းပြီး အချိန်မှန်လုပ်နိုင်သူ လိုအပ်သည်။",
  ...
  Job(
    ...
    distanceMiles: 2.1,
    isUrgent: true,
    aiSuggestedBudgetMmk: 24000,
    requiredTier: 4,
    dateTime: DateTime.now().add(const Duration(hours: 4)),
    description: "ဗီရိုတံခါးနှင့် မီးဖိုချောင်ခုံ အနည်းငယ် ပြင်ဆင်ရန်၊ အခြေခံကိရိယာပါသူ လိုအပ်သည်။",
  ...
  Job(
    ...
    distanceMiles: 0.9,
    isUrgent: false,
    aiSuggestedBudgetMmk: 14000,
    requiredTier: 1,
    dateTime: DateTime.now().add(const Duration(days: 3)),
    description: "အိမ်သုံးပစ္စည်းအထုပ်များကို လှိုင်မှ ကမာရွတ်သို့ သယ်ပို့ရန် လိုအပ်သည်။",
  ...
  Job(
    ...
    distanceMiles: 5.5,
    isUrgent: false,
    aiSuggestedBudgetMmk: 17000,
    requiredTier: 2,
    dateTime: DateTime.now().add(const Duration(days: 4)),
    description: "အိမ်ရှေ့ဥယျာဉ် မြက်ညှပ်၊ အပင်ချုံ့ပြီး အမှိုက်ရှင်းရန် လိုအပ်သည်။",
