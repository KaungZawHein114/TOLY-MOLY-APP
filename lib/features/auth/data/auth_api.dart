...
/// runserver 0.0.0.0:8000`). Currently set to the dev PC's LAN IP for
/// testing on a physical device (e.g. Samsung A53) over Wi-Fi — phone and
/// PC must be on the same network. Switch to `http://10.0.2.2:8000` for the
