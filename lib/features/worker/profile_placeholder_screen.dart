...
/// Stub for the worker bottom nav's "ပရိုဖိုင်" tab — reserves the
/// destination until the worker's own profile screen is built.
class WorkerProfilePlaceholderScreen extends StatelessWidget {
  const WorkerProfilePlaceholderScreen({super.key});
